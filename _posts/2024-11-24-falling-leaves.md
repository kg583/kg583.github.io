...
1. Solve this game. That is, for each $L$, $R \geq 0$, determine if, on a tree with $L$ leaves on the left and $R$ on the right, a win is forced for Autumn or Yvonne, and if so, outline a strategy for the winner to respond to any move from their opponent.

2. Read about https://en.wikipedia.org/wiki/Nim, either because you want to know more about combinatorial game theory, or you need a hint.
